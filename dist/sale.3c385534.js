...
},{"process":"node_modules/process/browser.js"}],"node_modules/datatables.net/js/dataTables.mjs":[function(require,module,exports) {
"use strict";
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"node_modules/datatables.net-dt/js/dataTables.dataTables.mjs":[function(require,module,exports) {
"use strict";
...
let $ = _jquery.default;
var _default = exports.default = _datatables.default;
},{"jquery":"node_modules/jquery/dist/jquery.js","datatables.net":"node_modules/datatables.net/js/dataTables.mjs"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/web/js/sale.js":[function(require,module,exports) {
"use strict";

require("regenerator-runtime/runtime");
var _datatables = _interopRequireDefault(require("datatables.net-dt"));
...
var products;
var clients;
var token = window.localStorage.getItem("token_de_acesso");
var config = {
  headers: {
...
$("#btnSalvar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var id, userId, prodId, clientId, quantity;
...
$("#btnLimpar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return (0, _axios.default)(url, config, bodyParameters);
        case 3:
        ...
        case 7:
          ...
          console.log("Erro ao atualizar a tabela: " + _context4.t0);
        case 10:
        case "end":
...
function _loadUser() {
  _loadUser = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var select;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return (0, _axios.default)("http://localhost:3000/users/", config, bodyParameters);
        case 2:
          user = _context5.sent;
          select = $("#selectUser");
...
function _loadClient() {
  _loadClient = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var select;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return (0, _axios.default)("http://localhost:3000/clients/", config, bodyParameters);
        case 2:
          clients = _context6.sent;
          select = $("#selectClient");
          clients.data.forEach(function (p) {
            var option = document.createElement('option');
            option.value = p['id'];
...
function _loadProduct() {
  _loadProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var select;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return (0, _axios.default)("http://localhost:3000/products/", config, bodyParameters);
        case 2:
...
function loadSaleTable() {
  return _loadSaleTable.apply(this, arguments);
}
function _loadSaleTable() {
  _loadSaleTable = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return (0, _axios.default)(url, config, bodyParameters).then(function (response) {
            var saleData = response.data;
            var _iterator = _createForOfIteratorHelper(saleData),
              _step;
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var sale = _step.value;
                sale.products = JSON.parse(sale.products);
                var _iterator2 = _createForOfIteratorHelper(sale.products),
                  _step2;
                try {
                ...
                sale.products = JSON.stringify(sale.products).replace(/"productName"/g, "Produto").replace(/"quantity"/g, "quantidade").replace(/[\[\]{}"]/g, "").split(",");
              }
...
function deleteSale(_x) {
  return _deleteSale.apply(this, arguments);
}
function _deleteSale() {
  _deleteSale = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(id) {
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          _context9.next = 3;
          return _axios.default.delete(url + id, config, bodyParameters);
        case 3:
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","datatables.net-dt":"node_modules/datatables.net-dt/js/dataTables.dataTables.mjs","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "54951" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/web/js/sale.js"], null)
//# sourceMappingURL=/sale.3c385534.js.map